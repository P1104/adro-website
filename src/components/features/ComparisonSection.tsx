...
const comparisonData = [
    {
        ...
        powerBi: "AI features with Copilot",
        tableau: "AI features with Tableau AI",
        excel: "AI features with Copilot",
    },
    {
        feature: "Natural Language Queries",
        adro: "Ask questions to your data",
        powerBi: "Q&A feature available ",
        tableau: "Limited natural language support",
        excel: "Limited support",
    },
    {
        feature: "Dashboard Generation",
        adro: "Automatic dashboards",
        powerBi: "Manual dashboard design",
        tableau: "Manual dashboard design",
        excel: "Manual charts",
    },
    ...
    },
    {
        ...
        tableau: "Requires visualization expertise",
