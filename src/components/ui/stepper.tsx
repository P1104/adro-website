    ...
    ({ asChild = false, className, children, ...props }, ref) => {
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    "relative flex size-6 shrink-0 items-center justify-center rounded-full bg-muted text-xs font-medium text-muted-foreground data-[state=active]:bg-primary data-[state=completed]:bg-primary data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground transition-colors duration-200",
                    className,
                )}
                data-state={state}
                {...props}
